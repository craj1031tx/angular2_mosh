System.register(['angular2/core', 'angular2/router', './time.component', './root.component'], function(exports_1) {
    ...
    var core_1, router_1, time_component_1, root_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    router_1.RouteConfig([
                        ...
                        { path: '/root', name: 'Root', component: root_component_1.RootComponent, useAsDefault: true },
                        { path: '/root/:year/:month', name: "Time", component: time_component_1.TimeComponent },
